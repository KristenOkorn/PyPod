# -*- coding: utf-8 -*-
"""
Created on Mon Mar  7 10:40:34 2022

Create scatterplots & color points by time
...
for i in range(5):
    ...
    if currentpod != keypod:
        ...
        #get the hours alone
        hours = full.index.hour
    
        #trying a different plotting method
        #initialize
        fig, ax = plt.subplots()
        #plot the basic scatterplot
        scatter = ax.scatter(full["YPOD{}".format(keypod)], full["YPOD{}".format(currentpod)], c=hours,alpha=0.5)
        #create the 1-1 line
        ...
        legend1 = ax.legend(*scatter.legend_elements(),
                    loc="lower right", title="Hour of Day")
        ax.add_artist(legend1)
    
        #final plotting & saving
        imgname = 'CH4_{}_{}_scatterplot_hourly.png'.format(keypod,currentpod)
